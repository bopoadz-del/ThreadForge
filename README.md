...
A20 PASS dirty={'dirty': True, 'change_id': 'CHG-bf52b84f', 'artefact_kinds': ['routes', 'supports', 'isometric', 'quantities', 'pcf', 'clash', 'ga', 'test_pack', 'work_package'], 'artefact_ids': ['ART-210-G-2001.pcf', 'ART-200-P-1001.pcf', 'ART-200-P-1002.pcf', 'ART-200-D-1010.pcf'], 'affected_wp_ids': [], 'affected_stages': ['topology', 'piping', 'outputs']} line=LINE-200-P-1001
...
A25 PASS status=202 body={"id":"job-49a07b8d90","job_id":"job-49a07b8d90","status":"queued"}
...
A30 FAIL tag=v1.0.1 remote=False local_sha=- remote_sha=-
ACCEPTANCE: 29/30 PASS
```
